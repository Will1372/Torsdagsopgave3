...
void setup() {
  ...
  println("Original name of the teacher: " + myTeacher.name);

  myTeacher.changeName("Mrs. Johnson");

  println("Updated name of the teacher: " + myTeacher.name);
...
void setup() {
  ...
  Teacher myTeacher = new Teacher("T. Hansen", 45, false);

  println("Original name of the teacher: " + myTeacher.name);

  myTeacher.changeName("M. Johansen");
